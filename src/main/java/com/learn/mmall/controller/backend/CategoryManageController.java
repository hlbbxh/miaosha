package com.learn.mmall.controller.backend;
...
public class CategoryManageController {
    ...
    @ResponseBody
    public ServerResponse addCategoryCon(HttpSession session,String categoryName,@RequestParam(value = "parentId",defaultValue = "0") int parentId){
